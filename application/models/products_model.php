...
class products_model extends CI_Model {
	...
	function disable($id) {
		...
		$audit = array('user_id' => $this->session->userdata('user_id'), 'module' => 'Products', 'remark_id' => $remark_id, 'remarks' => 'disabled product', 'date_created' => date('Y-m-j H:i:s'), );
	...
	public function enable($id) {
		...
		$audit = array('user_id' => $this->session->userdata('user_id'), 'module' => 'Products', 'remark_id' => $remark_id, 'remarks' => 'enabled product', 'date_created' => date('Y-m-j H:i:s'), );
	...
	public function update_class($clid) {
		...
		if (($val -> num_rows() == 1) && !$this->db->where('class_ID', $clid)) {
			...
			$data = array('class_Name' => $this->input->post('class_Name'), 'is_active' => $this->input->post('is_active'), );
			...
			$audit = array('user_id' => $this->session->userdata('user_id'), 'module' => 'Products/Class', 'remark_id' => $id, 'remarks' => 'created account', 'date_created' => date('Y-m-j H:i:s'), );
	...
	function addClass() {
		...
		if ($val -> num_rows() == 1) {
			...
			$audit = array('user_id' => $this->session->userdata('user_id'), 'module' => 'Products/Classes', 'remark_id' => $remark_id, 'remarks' => 'created class', 'date_created' => date('Y-m-j H:i:s'), );
