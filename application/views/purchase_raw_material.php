<div class="container bg-panel">
	...
	<div class="row">
		<div class="col-lg-12">
			<form class="form-group" method="post" accept-charset="utf-8" action="<?php echo base_url(); ?>products/purchase">
			...
			<div class="col-lg-6">
				...
				<div class="form-group">
					<div class="col-lg-3">
						...
						<input type="decimal" name="price" class="form-control inline" value="00.00" required>						</div>
					</div>
				</div>
