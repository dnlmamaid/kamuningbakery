				...
				<div class="col-lg-12">
					...
					<div class="col-lg-6 bg-panel2">
						...
						<div class="col-lg-12 form-group">
							...
							<button type="button" class="btn btn-caution pull-right" data-toggle="modal" data-target="#purchaseOrder" style="margin-left:5px;"><i class="fa fa-plus"></i> Order</button>
					...
					<div class="col-lg-6">
						<h1 align="center">Purchase Instances</h1>
					...
					<form class="form-group" method="post" accept-charset="utf-8" action="<?php echo base_url(); ?>products/replenish/<?php echo $r->product_id?>">
						...
						<div class="form-group">
							<div class="col-lg-8 col-xs-8">
								...
								<input type="number" step="0.01" name="price" class="form-control inline" required>
							</div>
						</div>
