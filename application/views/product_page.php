...
if($body == 'create_new_raw_material') {?>
<div class="container bg-panel">
		
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header"><i class="fa fa-lemon-o"></i> Create Raw Material</h1>
			<div class="col-lg-4 pull-left">
			<ol class="breadcrumb">
				<li><i class="fa fa-home"></i><a href="<?php echo base_url()?>"> Home</a></li>
				<li><i class="fa icon_cart"></i><a href="<?php echo base_url()?>inventory"> Inventory</a></li>
				<li><i class="fa fa-lemon-o"></i> Create Raw Material</li>
			</ol>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<h1>Raw Material Information</h1>
			...
			<div class="col-lg-6">
				...
				<div class="form-group">
					<div class="col-lg-3">
						<label for="terms">Unit</label>
						<input type="text" name="um" class="form-control inline" value="Piece" required>
					</div>
				</div>		
					
				<div class="form-group">
					<div class="col-lg-3">
						<label for="terms">Price Per Unit</label>
						<input type="number" name="price" class="form-control inline" value="00.00" required>						</div>
					</div>
				</div>
...
<?php }
else if($body == 'create_new_finished_good') {?>
<div class="container bg-panel">
		...
		<div class="col-lg-12">
			...
			<div class="col-lg-6">
				...
				<div id="materials" class="form-group">
					<div id="rm">
						<label class="col-lg-3 control-label">Raw Material</label>
			...
			<div class="col-lg-12">
				...
				<div class="col-lg-6">
					...
					<div class="form-group">
						<div class="col-lg-3">						
							<label class="control-label">Quantity</label>
							<input type="number" name="quantity" class="form-control inline" value="<?php echo $r->quantity?>" required>
						</div>
					</div>
